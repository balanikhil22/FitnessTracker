    ...
    <div className="max-w-4xl mx-auto bg-white shadow-md rounded-lg p-8">
      ...
      <form onSubmit={handleSubmit}>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-4">
          <div>
            ...
            <input
              ...
              className="w-full p-2 border border-gray-300 rounded-lg focus:outline-none focus:border-blue500"
              required
            />
          </div>
        </div>
        ...
        <div className="mt-6">
          <button
            type="submit"
            className="w-full bg-blue-800 text-white py-2 px-4 rounded-lg hover:bg-blue-600 focus:outline-none"
          >
            Update Profile
          </button>
        </div>
