  ...
  return (
    <div className="w-full h-screen flex items-center justify-center bg-gray-100">
      <div className="max-w-md w-full bg-white p-6 rounded-lg shadow-lg">
        <h2 className="text-3xl font-bold mb-6 text-blue800 text-center">
          Current Weather
        </h2>

        {loading ? (
          <p className="text-lg text-blue600 text-center">
            Loading weather data...
          </p>
        ) : error ? (
          <p className="text-lg text-blue600 text-center">{error}</p>
        ) : weatherData ? (
          <div>
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-semibold text-blue700">
                  {location.city}
                </h3>
                <p className="text-4xl font-bold text-blue900">
                  {Math.round(weatherData.current_weather.temperature)}°C
                </p>
                <p className="text-lg text-blue600">
            ...
            <div className="mt-6 p-4 border rounded-lg shadow-md bg-gray-50">
              <h4 className="text-xl font-bold text-blue800">Workout Tip</h4>
              <p className="text-lg text-blue700 mt-2">
