  ...
  return (
    <div className="container mx-auto p-5">
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark p-7">
        <h3 className="font-medium text-black  mb-6">Water Intake Tracker</h3>

        <form onSubmit={handleSubmit} className="flex flex-col gap-5">
          <div>
            <label className="mb-3 block text-black " for="water-intake">
              Water Intake (L)
            </label>
            <input
              id="water-intake"
          ...
          <button
            type="submit"
            className="flex w-full justify-center rounded bg-blue-800 p-3 font-medium text-white hover:bg-opacity-90"
          >
            Add Water Intake
          </button>
        </form>
